          ...
          return (
            ...
            >
              ...
              <div className="service-card">
                ...
                {/* Overlay */}
                <div
                  className={`absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 sm:opacity-0'} group-hover:opacity-100`}
                />
                
                {/* Content */}
                <div
                  className={`absolute inset-0 p-4 sm:p-6 flex flex-col justify-end transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 sm:opacity-0'} group-hover:opacity-100`}
                >
